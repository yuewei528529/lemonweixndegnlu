...
<form id="cmsCatalogForm" method="post" action="cms-site-save.do" class="form-horizontal">
  ...
  <div class="form-group">
	...
	<div class="col-sm-5">
	  <input id="cmsCatalog_templateIndex" type="text" name="templateCode" value="${model.templateCode}" size="40" class="form-control required" minlength="2" maxlength="50">
    </div>
  </div>
  <div class="form-group">
