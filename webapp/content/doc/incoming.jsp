  ...
  <div class="panel-body">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='${tenantPrefix}/operation/process-operation-viewStartFormByKey.do?key=doc-incoming'">新建申请</button>
		</div>
