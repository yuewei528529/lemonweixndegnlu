...
$(function() {
  ...
  <body>
    <%@include file="/header/stamp-user.jsp"%>

    <div class="row-fluid">
	  <%@include file="/menu/stamp-user.jsp"%>
  ...
  <div class="panel-body">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='${tenantPrefix}/operation/process-operation-viewStartFormByKey.do?key=stamp'">新建申请</button>
		</div>
  ...
  <table id="stamp-infoGrid" class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.deptCode}</td>
        <td><a href="${ctx}/rs/store/view?model=form&key=${item.filePath}">${item.fileName}</a></td>
