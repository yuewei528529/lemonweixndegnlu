				...
				setTimeout(function(){
					if (isOpen) {
						if ($T[0].offsetWidth > $T[0].offsetHeight) {
							$T[0].style.backgroundImage = "url('../images/toward_up.gif')";
							$R[0].style.backgroundImage = "url('../images/split_h.gif')";			
						} else {
							$T[0].style.backgroundImage = "url('../images/toward_left.gif')";
							$R[0].style.backgroundImage = "url('../images/split_v.gif')";			
						}
						$T[0].style.backgroundRepeat = "no-repeat";
					} else {
						if ($T[0].offsetWidth > $T[0].offsetHeight) {
							$T[0].style.backgroundImage = "url('../images/toward_down.gif')";
							$R[0].style.backgroundImage = "url('../images/split_h.gif')";			
						} else {
							$T[0].style.backgroundImage = "url('../images/toward_right.gif')";
							$R[0].style.backgroundImage = "url('../images/split_v.gif')";			
						}
						$T[0].style.backgroundRepeat = "no-repeat";
					}
